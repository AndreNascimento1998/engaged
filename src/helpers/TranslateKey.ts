export const enum TranslateKey {
  ...
  "Earth (Giant Telepathic Spiders Dimension)" = "Terra (Dimensão de Aranhas Telepáticas Gigantes)",
  ...
  "Earth (Evil Rick's Target Dimension)" = "Terra (Dimensão Alvo do Rick Maligno)",
  ...
  "Earth (Fascist Teddy Bear Dimension)" = "Terra (Dimensão do Urso Teddy Fascista)",
